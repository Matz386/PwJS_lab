...
#login: user1, hasło: user1_secret
#generacja uzytkownikow
users = [User(id) for id in range(1, 10)]

@app.route("/login", methods=["GET", "POST"])
def login():
    dane = {'tytul': 'Zaloguj się', 'tresc': 'Zaloguj się na konto.'}
...
def page_not_found(e):
    dane = {'tytul': 'Wystąpił błąd', 'blad': '401'}
...
@login_required
def lista():
    dane = {'tytul': 'Lista pracownikow', 'tresc': 'Zbiór pracowników'}
